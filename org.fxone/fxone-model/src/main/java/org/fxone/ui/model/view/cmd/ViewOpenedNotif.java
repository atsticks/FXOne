...
public final class ViewOpenedNotif extends AbstractNotification<Void> {
	...
	public static final NotificationType NOTIFTYPE = new NotificationType.Builder(
			"UI", "View:opened", "A view was opened.", Severity.DEBUG)
			.define(ViewOpenedNotif.class).addResult(Void.class)
			.buildAndRegister();

	public ViewOpenedNotif(View view, ViewContainer viewContainer) {
