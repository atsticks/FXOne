 ...
 */
public class WindowDialog extends Stage {
    ...
    public static class DialogBuilder {
        ...
        protected static final String ICON_PATH = "/org/homemotion/ui/fx/framework/widget/dialog/";
        
        protected WindowDialog stage;
        
        public DialogBuilder create() {
            stage = new WindowDialog();
        ...
        public DialogBuilder create(Node content) {
            stage = new WindowDialog();
            stage.setResizable(false);
            stage.initStyle(StageStyle.UTILITY);
            stage.initModality(Modality.APPLICATION_MODAL);                        
            ...
            // message
            stage.borderPanel.setCenter(content);
            BorderPane.setAlignment(content, Pos.CENTER);
            BorderPane.setMargin(content, new Insets(MARGIN, MARGIN, MARGIN, 2 * MARGIN));
        ...
        // NOTE: invoke once during WindowDialog creating
        ...
        public DialogBuilder addOkButton(final EventHandler<ActionEvent> h) {
            stage.okButton = new Button("OK");
            stage.okButton.setPrefWidth(BUTTON_WIDTH);
            stage.okButton.setOnAction(new EventHandler<ActionEvent> () {
        ...
        public DialogBuilder addConfirmationButton(String buttonCaption, final EventHandler actionHandler) {
		...
		public void addContent(Node node) {
			stage.messageBox.getChildren().add(node);
		}
